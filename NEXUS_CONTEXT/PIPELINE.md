...
- [ ] **Task A5:** Phase 2 gate test suite — baseline audit reopened task. Blocked pending pure-logic P2-3 (no React runtime) and reproducible vitest/typecheck evidence after bootstrap. (Owner: `@codex`)
